<template>
    ...
    <div class="container-fluid">
        ...
        <div class="training-block">
           <div class="training" v-for="(training, index) in filteredGevolgd" v-bind:key="training.training_id">
				<div class="line">
					<div class="line-tekst">
						<p>{{index + 1}}. {{training.tName}}</p>
						<router-link :to="'/exampage/'+training.training_id"><b-button class="start-btn">Start</b-button></router-link>
					</div>
				</div>
			</div>
		</div>
